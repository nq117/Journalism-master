...
/**
 * Created by Administrator on 2017/3/28. 科技
 */

public class StFragment extends Fragment {

    private final static int ST = 1;
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case ST:
                    JuheBean juhe = JSON.parseObject(preferencesUtil.getString("St", null), JuheBean.class);
    ...
    private void initData() {
        ...
        }, Constant.Url.ApiKJ, Constant.Common.AppKey);
    }
    ...
    private void loadGetLastest(String result) {
        ...
        if (juhe != null){
            ...
            adapter.notifyDataSetChanged();
            LiteUtils.setLite("StFragment", getActivity());
            String json = JSON.toJSONString(juhe);
            preferencesUtil.setString("St", json);
        }
    }
