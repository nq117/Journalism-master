...
/**
 * Created by Administrator on 2017/3/28. 国内
 */

public class DomesticFragment extends Fragment {

    private final static int DOMESTIC = 1;
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case DOMESTIC:
                    JuheBean juhe = JSON.parseObject(preferencesUtil.getString("Domestic", null), JuheBean.class);
...
//        if (newsdb != null && newsdb.equals("DomesticFragment") && NetworkState.networkConnected(getActivity()) == false) {
//            handler.sendEmptyMessage(DOMESTIC);
//        } else {
//            initData();
//        }
    ...
    private void initData() {
        ...
        }, Constant.Url.ApiGN, Constant.Common.AppKey);
    }
    ...
    private void loadGetLastest(String result) {
        ...
        if (juhe != null){
            ...
            adapter.notifyDataSetChanged();
            LiteUtils.setLite("DomesticFragment", getActivity());
            Log.e("bb", String.valueOf(juhe));
            String json = JSON.toJSONString(juhe);
            preferencesUtil.setString("Domestic", json);
            Log.e("cc", preferencesUtil.getString("Domestic", null));
        }
    }
